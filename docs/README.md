...
| **MRP e Planejamento** (MRP, CRP, APS, previsão, calendário, prioridade) | [`mrp-planejamento`](apresentacao/mrp-planejamento.md) | [`mrp-calculo`](dev/mrp-calculo.md) · [`manufatura-e-compras`](dev/manufatura-e-compras.md) · [`aceite enterprise`](dev/mrp-aceite-enterprise.md) |
