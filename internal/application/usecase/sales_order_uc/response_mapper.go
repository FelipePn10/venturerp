...
func toSalesOrderResponse(o *entity.SalesOrder) *response.SalesOrderResponse {
	...
	return &response.SalesOrderResponse{
		...
		CommercialAnalysisStatus:    string(o.CommercialAnalysisStatus),
		FinancialAnalysisStatus:     string(o.FinancialAnalysisStatus),
		ReleaseStatus:               string(o.ReleaseStatus),
		ConferenceStatus:            string(o.ConferenceStatus),
		CancelReason:                o.CancelReason,
		CancelComplement:            o.CancelComplement,
		AttendedReason:              o.AttendedReason,
		AttendedAt:                  o.AttendedAt,
		DelayReason:                 o.DelayReason,
		DelayAction:                 o.DelayAction,
