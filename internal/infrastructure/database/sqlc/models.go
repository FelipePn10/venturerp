...
type CommercialCommissionEvent struct {
	ID             pgtype.UUID
	EnterpriseID   int64
	LedgerCode     int64
	EventType      string
...
type CommercialCommissionLedger struct {
	Code               int64
	EnterpriseID       int64
...
type CommercialCommissionSetting struct {
	EnterpriseID    int64
	CompetenceEvent string
	InvoiceSharePct pgtype.Numeric
	ReceiptSharePct pgtype.Numeric
	UpdatedAt       pgtype.Timestamptz
...
type DeliveryRescheduleBatch struct {
	ID             pgtype.UUID
	EnterpriseCode int64
	SalesOrderCode int64
	IdempotencyKey string
...
type EmployeeCreditLimit struct {
	EnterpriseID int64
	EmployeeID   int64
	CreditLimit  pgtype.Numeric
...
type GlobalUnitConversion struct {
	ID           int64
	EnterpriseID int64
	FromUom      string
	ToUom        string
...
type ItemEngineeringDrawing struct {
	EnterpriseID int64
	ItemCode     int64
	Mask         string
	DrawingCode  string
...
type MachinePreventiveService struct {
	ID             int64
	EnterpriseID   int64
	MachineID      int64
	ServiceID      int64
	...
	MaxTolerance   int32
	SupplierCode   *int64
	ImplementedOn  pgtype.Date
	LastExecutedOn pgtype.Date
...
type MachineServiceItem struct {
	ID               int64
	EnterpriseID     int64
	MachineServiceID int64
	ItemCode         int64
	Quantity         pgtype.Numeric
	Notes            pgtype.Text
}

type MachineServiceResponsible struct {
	MachineServiceID int64
	EmployeeID       int64
	EnterpriseID     int64
}

type MachineSpecialField struct {
	ID           int64
	EnterpriseID int64
	Name         string
	ValueType    string
...
type MachineSpecialValue struct {
	MachineID    int64
	FieldID      int64
	EnterpriseID int64
...
type MachineType struct {
	...
	EnterpriseID        *int64
	MachineCostCenterID *int64
	LaborCostCenterID   *int64
	CapacityHours       pgtype.Numeric
}
...
type ManufacturingItemParameter struct {
	EnterpriseID                       int64
	Parameter8ReplicateDrawingRevision bool
	UpdatedAt                          pgtype.Timestamptz
	UpdatedBy                          pgtype.UUID
}
...
type ManufacturingSequencingSetting struct {
	EnterpriseID            int64
	ListOnlyActiveResources bool
	UpdatedAt               pgtype.Timestamptz
}

type ManufacturingStockClosedPeriod struct {
	ID           int64
	EnterpriseID int64
...
type ManufacturingStockItemControl struct {
	EnterpriseID       int64
	ItemCode           int64
	StockUom           string
	ControlsLot        bool
...
type ManufacturingStockParameter struct {
	EnterpriseID  int64
	LotReturnMode string
	AutoIssueLots bool
	MovementFrom  pgtype.Date
	MovementTo    pgtype.Date
}

type ManufacturingStructuralAudit struct {
	ID           int64
	EnterpriseID int64
	EntityType   string
	EntityKey    string
...
type ManufacturingWarehouseAddress struct {
	EnterpriseID int64
	WarehouseID  int64
	Address      string
	IsActive     bool
...
type ProcurementImmutableAudit struct {
	ID            int64
	EnterpriseKey int64
	EntityType    string
	EntityKey     string
...
type ProductionOrderScrapDestination struct {
	...
	ReturnQuantity            pgtype.Numeric
	ScrapQuantity             pgtype.Numeric
	SourceUom                 string
	ScrapUom                  string
}
...
type ProductionResourceGroup struct {
	ID           int64
	EnterpriseID int64
	Code         string
	Description  string
...
type PurchaseOrderCurrencyRate struct {
	ID           int64
	EnterpriseID int64
	CurrencyCode string
...
type RecurringSale struct {
	...
	PriceTableCode            *int64
	CurrencyCode              string
	AdjustmentIndex           pgtype.Text
	AdjustmentPeriodMonths    *int32
	AdjustmentFloorPct        pgtype.Numeric
	AdjustmentCapPct          pgtype.Numeric
	BillingPolicy             []byte
	DeliveryPolicy            []byte
	TaxPolicy                 []byte
	CostCenterCode            *int64
	RenewalPolicy             string
	CancellationEffectiveDate pgtype.Date
	FutureOrdersPolicy        pgtype.Text
...
type RecurringSalesEvent struct {
	ID                pgtype.UUID
	EnterpriseCode    int64
...
type RecurringSalesOperation struct {
	ID                pgtype.UUID
	EnterpriseCode    int64
	RecurringSaleCode int64
...
type TechnicalAssistanceRma struct {
	Code                int64
	EnterpriseID        int64
	CallCode            int64
	Status              string
	ReasonCode          string
	ReasonDescription   pgtype.Text
	EligibilityStatus   string
	EligibilityReason   string
	AuthorizationNumber pgtype.Text
	AuthorizedAt        pgtype.Timestamptz
	ReverseCarrierCode  *int64
	ReverseTrackingCode pgtype.Text
	ReceivedAt          pgtype.Timestamptz
	InspectionNotes     pgtype.Text
	InspectedAt         pgtype.Timestamptz
	Destination         pgtype.Text
	SlaDueAt            pgtype.Timestamptz
	ProductCost         pgtype.Numeric
	FreightCost         pgtype.Numeric
	ServiceCost         pgtype.Numeric
	FiscalDocumentKey   pgtype.Text
...
type TechnicalAssistanceRmaEvent struct {
	Code          int64
	EnterpriseID  int64
	RmaCode       int64
	EventType     string
...
type TechnicalAssistanceRmaEvidence struct {
	ID           pgtype.UUID
	EnterpriseID int64
	RmaCode      int64
	FileName     string
...
type TechnicalAssistanceRmaItem struct {
	Code                 int64
	RmaCode              int64
	CallItemCode         int64
	ItemCode             int64
	...
	RequestedDestination pgtype.Text
...
type ThirdPartyServiceMovement struct {
	ID             int64
	EnterpriseID   int64
...
type ThirdPartyServiceOrder struct {
	ID                      int64
	Code                    int64
	EnterpriseID            int64
	ProductionOrderID       int64
...
type ThirdPartyServiceOrderHistory struct {
	ID             int64
	EnterpriseID   int64
	ServiceOrderID int64
	EventType      string
...
type ThirdPartyServicePrice struct {
	ID               int64
	EnterpriseID     int64
	ItemCode         int64
	Mask             string
...
type ThirdPartyServicePriceHistory struct {
	ID           int64
	EnterpriseID int64
	PriceID      int64
	Action       string
...
type ThirdPartyServicePriceRule struct {
	ID             int64
	EnterpriseID   int64
	PriceID        int64
...
type WarehouseInventoryAudit struct {
	ID           int64
	EnterpriseID int64
	EntityType   string
	EntityKey    string
