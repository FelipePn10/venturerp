...
INSERT INTO items (
    ...
    created_at
             ...
             sqlc.arg(supplies_receiving_checklist), sqlc.arg(supplies_harvest), sqlc.narg(supplies_notes), sqlc.arg(commercial_warranty_days),
...
UPDATE items SET
 ...
 -- Os três campos abaixo não estavam na alteração: o almoxarifado principal,
 -- o de suprimentos e o consumo médio manual ficavam como na criação.
 supplies_warehouse_code=sqlc.narg(supplies_warehouse_code),
 supplies_notes=sqlc.narg(supplies_notes),
 warehouse_code=sqlc.arg(warehouse_code),
 warehouse_avg_monthly_consumption_manual=sqlc.narg(warehouse_avg_monthly_consumption_manual),
