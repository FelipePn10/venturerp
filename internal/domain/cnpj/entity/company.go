...
// Federal) company lookup by CNPJ. It is provider-agnostic: BrasilAPI, CNPJá or
// any future source maps onto this same shape so the rest of the system never
// learns which API answered.
package entity
...
type Company struct {
	...
	// Source identifies which provider answered (e.g. "brasilapi", "cnpja"),
	// useful for auditing and for explaining missing IE data to the user.
	Source string
}
